...
function removeItem(type=0){
  ...
  $.ajax({
    url: 'http://localhost/DOTShop/Admin/Ajax/removeItem',
    method: 'post',
    data: {
      itemID: itemID,
      type: type
...
function loadProductAdmin(){
  $.ajax({
    url: 'http://localhost/DOTShop/Admin/Ajax/loadProductAdmin',
    method: 'post',
    success: function(response) {
...
function loadUserAdmin(){
  $.ajax({
    url: 'http://localhost/DOTShop/Admin/Ajax/loadUserAdmin',
    method: 'post',
    success: function(response) {
...
(function($) {
  ...
  $('#editProduct').click(function(){
    ...
    $.ajax({
      url: 'http://localhost/DOTShop/Admin/Ajax/editProduct',
      method: 'post',
      data: formData,
      contentType: false,
      processData: false,
  ...
  $('#addProduct').click(function(){
    ...
    $.ajax({
      url: 'http://localhost/DOTShop/Admin/Ajax/addProduct',
      method: 'post',
      data: formData,
      contentType: false,
      processData: false,
  ...
  $('#resetPass').click(function(){
    ...
    $.ajax({
      url: 'http://localhost/DOTShop/Admin/Ajax/resetPass',
      method: 'post',
      data: {
        id: id,
        newPass: newPass
  ...
  $('#editUser').click(function(){
    ...
    $.ajax({
      url: 'http://localhost/DOTShop/Admin/Ajax/editUser',
      method: 'post',
      data: {
        id: id,
        name: name,
  ...
  $('#addUser').click(function(){
    ...
    $.ajax({
      url: 'http://localhost/DOTShop/Admin/Ajax/insertUser',
      method: 'post',
      data: {
        addName: addName,
        addPass: addPass,
  ...
  $('.add-user-form input').keyup(function(){
    ...
    $.ajax({
      url: 'http://localhost/DOTShop/Admin/Ajax/checkNameAdmin',
      method: 'post',
      data: {
        inputName: inputName
      },
